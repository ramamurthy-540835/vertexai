...
CONSTRAINT unique_confidence_level UNIQUE (confidence_level)
 ...
 CREATE TABLE IF NOT EXISTS
  "$SCHEMA_NAME".transaction ( 
    ...
    oms_phone_1           VARCHAR(100),
    oms_phone_2           VARCHAR(100),
    oms_phone_3           VARCHAR(100),
    oms_cell_1            VARCHAR(100),
    oms_cell_2            VARCHAR(100),
    oms_first_name        VARCHAR(100),
    oms_middle_name       VARCHAR(100),
    oms_last_name         VARCHAR(100),
    oms_address_line_1    VARCHAR(150),
    oms_city              VARCHAR(100),
    oms_state             VARCHAR(100),
    oms_zip               VARCHAR(100),
    ...
    oms_city_2            VARCHAR(100),
    oms_state_2           VARCHAR(100),
    oms_zip_2             VARCHAR(100),
