...
def check_connection():
    from costco.leadmgmt.components.test_service_now_connectivity import check_connection
...
def my_pipeline(
    ...
    check_snow_status = check_connection()
    check_snow_status.set_display_name("Check service Now connectivity")
