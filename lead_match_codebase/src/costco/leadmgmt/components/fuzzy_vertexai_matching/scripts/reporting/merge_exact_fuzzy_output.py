...
Usage:
    python3 lead_match_codebase/src/costco/leadmgmt/components/fuzzy_vertexai_matching/scripts/reporting/merge_exact_fuzzy_output.py \
...
def main():
    ...
    parser.add_argument("--rules-json", default=os.getenv("LEAD_POS_RULES_PATH"), help="Path to business rules JSON (empty = default from business_rules.py)")
