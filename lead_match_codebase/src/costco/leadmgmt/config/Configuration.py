...
class DatabaseDetail:
    ...
    def __repr__(self):
        return str({"db_user" : self.db_user, "db_password":"*********" ,"schema_name" : self.schema_name
                ...
                ,"project_id" : self.project_id ,"insert_lead_table_name": self.insert_lead_table_name,"insert_pos_table_name": self.insert_pos_table_name
...
class SnowConfig:
    ...
    def from_env(cls):
        ...
        match_result_update_url = os.environ.get("MATCH_RESULT_UPDATE_URL")
...
class TransformConfig:
    ...
    def __repr__(self):
        return {"initial_load_lead_mapping": self.initial_load_lead_mapping, "initial_load_pos_mapping": self.initial_load_pos_mapping
    ...
    def from_config(cls,config):
        ...
        return cls(
            ...
            pos_columns=json.loads(config.get('TRANSFORMATION', 'lead_columns')),
...
class JobConfig:
    ...
    def __init__(self, config_file='config.ini'):
        ...
        self.match_job_name = self.get_config("GENERAL",
                                        "location", config, "lead_match_job")
